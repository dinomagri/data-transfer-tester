...
from .models import scpData, gridftpData, wgetData, iperfData, axelData, udrData, aria2cData, xrootdData, fdtData
...
class xrootdAdmin(admin.ModelAdmin):
	class Meta:
		model = xrootdData

class fdtAdmin(admin.ModelAdmin):
	class Meta:
		model = fdtData
...
admin.site.register(xrootdData, xrootdAdmin)
admin.site.register(fdtData, fdtAdmin)
